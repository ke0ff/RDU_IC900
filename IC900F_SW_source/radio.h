...
// These registers are all placed after the VFO structs
...
//====================== END OF NVRAM BASE DATA DEFINES =================================
// CTCSS flags
...
#define	MHZ_TIME		PSEC10		// MHZ digit mode timeout
#define	VQ_TIME			PSEC3		// vol/squ adj timeout
...
#define	TSW_TIME		PSEC10		// TS adj timeout
#define	SLIDE_TIME		PSEC300MS	// text slider display shift rate
#define	SCAN_TIME		PSEC400MS	// scan channel rate
#define	SCAN_TIME2		PSEC1		// scan channel LOS hold time
#define	SCAN_TIME3		PSEC100MS	// scan band switch debounce time
