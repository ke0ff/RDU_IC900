...
#define	VMODE_ISRX		0x00	// rx mode
...
#define	SLIDE_IPL		0xff
#define	SLIDE_START		0x01
#define	SLIDE_RUN		0x00

// Xz-flags
//#define	OFFS_XFLAG	0x
#define	STATM_MODE		0x04		// Status display (ASCII) MAIN
#define	STATS_MODE		0x08		// Status display (ASCII) SUB
